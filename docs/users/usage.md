...
✅ **Downloaded 1,402+ skill files** to your computer (default: `~/.gemini/antigravity/skills/`; or a custom path like `~/.agent/skills/` if you used `--path`)  
...
- You installed a toolbox with 1,402+ tools (✅ done)
...
Don't try to use all 1,402+ skills at once. Here's a sensible approach:
...
No. Even though you have 1,402+ skills installed locally, you should **not** concatenate every `SKILL.md` into a single system prompt or context block.
