...
- **CRITICAL PRE-REQUISITE**: You must actively read the test contract generated by the Evaluator from `/docs/design/contracts/<screen>.contract.yaml`, `.ascii.md`, and `.component-map.json` before coding.
