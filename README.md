<!-- registry-sync: version=9.12.0; skills=1402; stars=32204; updated_at=2026-04-11T18:53:12+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,402+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,402+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,402+ skills across development, testing, security, infrastructure, product, and marketing.
...
If you want a faster answer than "browse all 1,402+ skills", start with a tool-specific guide:
